...
<html>
  <head>
    ...
    <title>Smansa Voting| Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b>Pemira</b>Vote</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Smansa-</b>Pemira</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <span class="hidden-xs"><i class="fa fa-user"></i> Sulaiman Panji</span> &nbsp;<i class="fa fa-caret-down"></i>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <a data-toggle="modal" href="#myModal">Tangkoh</a>
                  </li>
                </ul>
              </li>
            </ul>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel">Tangkoh</h4>
                </div>
                <div class="modal-body">
                  Nge Yakin Ke Male Tangkoh?
                </div>
                <div class="modal-footer">
                  <a href="?page=logout" class="btn btn-danger">Sign Out</a>
                  <button type="button" class="btn btn-default" data-dismiss="modal">Tutupen</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; pemirasmansa2021 <a href="khairililmi2468@gmail.com">KHAIRIL ILMI</a>.</strong> PUTRA TANOH GAYO : <a href="Khairililmi2468@gmail.com">khairililmi2468@gmail.com</a>
      </footer>
